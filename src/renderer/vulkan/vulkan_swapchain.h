...
void vulkan_swapchain_create(vulkan_context *device, u32 width, u32 height, vulkan_swapchain *out_swapchain);

void vulkan_swapchain_recreate(vulkan_context *device, u32 width, u32 height, vulkan_swapchain *swapchain);
